...
if (isset($_POST['notice_submit_btn'])) {
	...
	*/
	...
	$sql = "INSERT INTO $db_posts_table(date_time, subject, post, posted_by) VALUES('$date', '$subject', '$content', '$admin_user')";
...
<div id='menu'>
	<p class='a_right'>Menu : <a href="../index.php">Admin Home</a> | <a href="view_post.php">View Posts</a> | <a href="add_user.php">Add New User</a> | <a href='../logout.php'>Log Out</a></p>
</div>
<br><br><br><br>
...
<form method="POST" action="create_post.php">
	<table border="1" align="center" id="t1">
		<tr>
			...
			<br><br>
			<p align="right"><input type="submit" name="notice_submit_btn" value=" Post "></p></td>
		</tr>
	</table>
